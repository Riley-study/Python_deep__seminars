...
# Для тестированию возьмите pickle версию файла из задачи 4 семинара. Функция должна извлекать ключи словаря
...
if __name__ == "__main__":
    pickle_to_csv("../example/data_task4.pickle", "example/test.csv")